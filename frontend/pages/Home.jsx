      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className=" border border-gray-300 md:border-gray-200 shadow-lg md:border-3 w-full max-w-md px-2 rounded-lg mt-5 ">
          <div className="my-4">
            ...
            <p className="mx-7 md:mx-9 md:text-lg ">
              {" "}
        ...
        <div className="flex justify-end h-88 md:h-40 items-end">
          ...
          <div className="mx-5">
            ...
            <button className="w-full p-2 bg-gray-900 text-white rounded-lg text-lg md:text-lg mt-4 cursor-pointer hover:bg-gray-800 hover:text-gray-400">
              <Link to="/search" className="text-sm md:text-md text-center ">
                Continue
              </Link>
            </button>
          </div>
